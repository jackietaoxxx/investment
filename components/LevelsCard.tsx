...
const LevelsCard: React.FC<LevelsCardProps> = ({ qqq, spy }) => {
  return (
    <div className="bg-slate-800 rounded-xl border border-slate-700 p-6">
      <h3 className="text-slate-100 font-bold text-lg mb-4">Key Levels (Next Session)</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-slate-500 text-xs">Current: {qqq.indicators.close}</span>
          </div>
          <div className="space-y-2">
             ...
             <div className="flex justify-between text-sm">
                <span className="text-emerald-300 font-medium">Support</span>
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
             ...
             <span className="text-slate-500 text-xs">Current: {spy.indicators.close}</span>
          </div>
          <div className="space-y-2">
             <div className="flex justify-between text-sm">
                <span className="text-red-300 font-medium">Resistance</span>
